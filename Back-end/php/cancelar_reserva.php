...
// Obtener cancelaciones de reservas
$query_cancelaciones = "SELECT c.id, r.id AS reserva_id, u.nombre_completo AS cliente, h.nombre AS habitacion, s.id AS sub_habitacion, c.fecha_cancelacion 
...
if (!$resultado_cancelaciones) {
    die("Error en la consulta de cancelaciones: " . mysqli_error($conexion));
}
?>
<!DOCTYPE html>
<html lang="es">
        ...
        <div id="lista-reservas">
            <table>
                ...
                <tbody>
                    ...
                    <?php endwhile; ?>
                    <?php while ($cancelacion = mysqli_fetch_assoc($resultado_cancelaciones)): ?>
                        <tr>
                            <td><?php echo $cancelacion['cliente']; ?></td>
                            <td><?php echo $cancelacion['habitacion']; ?></td>
                            <td><?php echo $cancelacion['sub_habitacion']; ?></td>
                            <td colspan="2">Cancelada</td>
                            <td><?php echo $cancelacion['fecha_cancelacion']; ?></td>
                        </tr>
                    <?php endwhile; ?>
                </tbody>
            </table>
